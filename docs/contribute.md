...
3. We recommend that you install [VSCode](https://code.visualstudio.com/) and some plugins. We wrote a [blog post]({% post_url 2021-02-05-cheminfo_dev_setup %}) describing how to set up the development environment and the first section discusses the VSCode setup.
...
6. Make changes to the code or documentation. And commit them. We have a [blog post]({% post_url 2021-02-05-cheminfo_docs %}) describing how the documentation works.
7. Push the changes to the remote and make a pull request.

We go through steps 4--7 in a video tutorial in the [blog post]({% post_url 2021-02-05-cheminfo_docs %}).
